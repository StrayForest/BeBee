...
| D-012 | LOCKED | Canonical proposed region order is Sunny Meadows → Golden Fields → Wetland Garden → Rosewood → Alpine Bloom → Moon Garden. | P7 productionizes Golden Fields as the second authored region and real browser evidence derives it after Sunny Meadows completion without a new navigation system. Wetland Garden, Rosewood, Alpine Bloom and Moon Garden remain later content proposals until their own P7 slices are accepted. |

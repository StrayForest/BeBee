...
| D-011 | HYPOTHESIS | Six-meadow first-region structure: First Patch, Clover Bend, Lavender Bank, Creek Garden, Tulip Rise, Lily Clearing. | Validate pacing after core loop prototype; P4 proves only the first authored meadow and does not validate the six-meadow count. |

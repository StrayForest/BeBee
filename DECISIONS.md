...
| D-012 | LOCKED | Canonical proposed region order is Sunny Meadows → Golden Fields → Wetland Garden → Rosewood → Alpine Bloom → Moon Garden. | P7 real browser evidence now accepts Golden Fields, Wetland Garden and Rosewood as sequential authored regions in the same continuous world without a new navigation system. Alpine Bloom and Moon Garden remain later content proposals until their own P7 slices are accepted. |
